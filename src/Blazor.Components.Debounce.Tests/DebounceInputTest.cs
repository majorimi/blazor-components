...
{
	[TestClass]
	public class DebounceInputTest
	{
		...
		public void Init()
		{
			...
			var mock = new Mock<ILogger<DebounceInput>>();
			_testContext.Services.Add(new ServiceDescriptor(typeof(ILogger<DebounceInput>), mock.Object));
		}
