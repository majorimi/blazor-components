...
public class LoadingPageTest : ComponentsTestBase<LoadingPage>
{
	...
	{
		var rendered = _testContext.RenderComponent<LoadingPage>(parameters =>
			parameters
	...
	public void LoadingPage_should_rendered_correctly_html_attributes()
	{
		...
		rendered.MarkupMatches(
			@"<div class=""loading"" style=""background-color: rgba(128, 128, 128, 0.9)"" id=""id1"" title=""text""><div class=""loading-content"">loading...</div></div>"
		);
	}
	...
	public void LoadingPage_should_rendered_correctly_default_state()
	{
		...
		Assert.IsNotNull(div);
		rendered.MarkupMatches(
			@"<div class=""loading"" style=""background-color: rgba(128, 128, 128, 0.9)""><div class=""loading-content"">loading...</div></div>"
		);
	}
	...
	public void LoadingPage_should_rendered_correctly_rounded_opacity()
	{
		...
		Assert.IsNotNull(div);
		rendered.MarkupMatches(
			@"<div class=""loading"" style=""background-color: rgba(128, 128, 128, 0.12)""><div class=""loading-content"">loading...</div></div>"
		);
	}
	...
	public void LoadingPage_should_rendered_correctly_calculated_rgb_background()
	{
		...
		Assert.IsNotNull(div);
		rendered.MarkupMatches(
			@"<div class=""loading"" style=""background-color: rgba(255, 0, 0, 0.9)""><div class=""loading-content"">loading...</div></div>"
		);
	}
	...
	public void LoadingPage_should_rendered_correctly_loading_state()
	{
		...
		rendered = _testContext.RenderComponent<LoadingPage>(parameters =>
			parameters
				.Add(p => p.IsLoading, false)
				.Add(
					p => p.LoadingContent,
