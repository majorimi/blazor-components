...
![Google Static Map demo](https://github.com/majorimi/blazor-components/raw/main/.github/docs/gifs/maps_googleStatic.gif)
...
![Google JS Map demo](https://github.com/majorimi/blazor-components/raw/main/.github/docs/gifs/maps_googleJs.gif)
...
This API has many features and since it is interactive user interactions will change original parameters. 
